<%
	...
	String DB_URL = "jdbc:mysql://localhost:3306/testuser";
	String DB_USERNAME = "tester"; // update to use your non-root password
	String DB_PASSWORD="password";	// replace with the password for the user
%>
