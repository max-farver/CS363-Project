<%
	...
	String DB_URL = "jdbc:mysql://localhost:3306/group5?noAccessToProcedureBodies=true";
	String DB_USERNAME = "cs363"; // update to use your non-root password
	String DB_PASSWORD="speedIsAnUnderratedMovie";	// replace with the password for the user
%>
