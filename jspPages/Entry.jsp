...
<body>
	...
	<p>Please enter all states as the full (capital first letter, the rest lower case)</p>
	...
	<ul>
		...
		<li>Insert: screen_name  | name   | sub_category | category  | ofstate | numFollowers | numFollowing</li>
		<li>Delete: screen_name</li>
	</ul>
	<form method="post" action="ShowResult.jsp">
		<div>
			<!-- The log in section, needs to be done each time a query is entered -->
			<h4>Login Each Time (sorry)</h4>
			<input type="text" name="username" placeholder="Username">
			<input type="text" name="password" placeholder="Password">	
		</div>
		<br>
		<br>
		<!-- Question section of form submission, select tag is for questions, the rest is for parameters for the query -->
		...
		<input type="text" name="user_input_6" placeholder="Param 6">
		<input type="text" name="user_input_7" placeholder="Param 7">
		<br>
